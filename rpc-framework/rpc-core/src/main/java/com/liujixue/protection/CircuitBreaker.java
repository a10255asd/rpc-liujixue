...
public class CircuitBreaker {
    ...
    public boolean isBreak() {
        ...
        if (errorRequest.get() > 0
                && requestCount.get() > 0
                && (float) errorRequest.get() / requestCount.get() > maxErrorRate) {
            this.isOpen = true;
            return true;
        }
        return false;
    ...
    public static void main(String[] args) {
        CircuitBreaker circuitBreaker = new CircuitBreaker(3,1.2F);
        new Thread(()->{
